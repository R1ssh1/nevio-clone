...
const info = products.find(p => p.slug === '/products/hollow-sections') ?? {
    ...
    description3: 'Vedantara Metal & Alloys manufactures Hollow Sections under the stringent supervision of proficient engineers. All sections conform to IS 4923, EN 10210, EN 10219, ASTM A500 standards.',
