export const navigation = [
    ...
    { label: 'About Us', path: '/about-us' },
    {
        ...
        path: '/products',
        children: [
            { label: 'Pipes & Tubes', path: '/pipes-tubes' },
            { label: 'Plates & Sheets', path: '/sheets-coils' },
            { label: 'Round Bars', path: '/round-bars' },
            { label: 'Flanges', path: '/products' },
            { label: 'Forged Fittings', path: '/products' },
            { label: 'Buttweld Fittings', path: '/products' },
            { label: 'Fasteners', path: '/products' },
            { label: 'Hollow Sections', path: '/products' },
            { label: 'Wires', path: '/wires' },
        ],
    },
